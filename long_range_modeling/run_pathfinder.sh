...
CUDA_VISIBLE_DEVICES=${gpu} python run_tasks.py --model ${model} --task ${task}
    ...
    --n_train_samples 160000 --n_dev_samples 20000 --n_test_samples 20000 --max_seq_len 1024
    --num_train_steps 150000  --num_eval_steps 78 --eval_frequency 100 --batch_size 256
    --seed ${seed}
"
...
runexp   0      pathfinder32-curv_contour_length_14  lsta      2    32    -1      8     1e-4  0.00 4096
